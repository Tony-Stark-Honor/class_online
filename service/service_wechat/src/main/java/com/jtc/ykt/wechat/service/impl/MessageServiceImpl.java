...
import com.jtc.ykt.client.course.CourseFeignClient;
...
/**
 * @Author: 小天
 * @Date: 2023/9/4 - 09 - 04 - 18:52
 * @Decsription: com.jtc.ykt.wechat.service.impl
 * @version: 1.0
 */
@Service
public class MessageServiceImpl implements MessageService {
    ...
    private String aboutUs(Map<String, String> param) {
        return this.text(param, "云堂现开设Java、HTML5前端+全栈、大数据、全链路UI/UE设计、人工智能、大数据运维+Python自动化、Android+HTML5混合开发等多门课程，满足了全国编程爱好者对多样化学习场景的需求，已经为行业输送了大量IT技术人才。").toString();
    }
    ...
    private String subscribe(Map<String, String> param) {
        //处理业务
        return this.text(param, "感谢你关注“云课堂”，可以根据关键字搜索您想看的视频教程，如：JAVA基础、Spring boot、大数据等").toString();
    }
    ...
    private String search(Map<String, String> param) {
        ...
        if(CollectionUtils.isEmpty(courseList)) {
            ...
            articles.append("<Url><![CDATA[http://cljj.mynatapp.cc/#/liveInfo/"+course.getId()+"]]></Url>");
            articles.append("</item>");
    ...
    public void pushPayMessage(long orderId) {
        String openid = "oJzYp6vftCZe7skDlwU8qCo9bOJY";
        WxMpTemplateMessage templateMessage = WxMpTemplateMessage.builder()
                .toUser(openid)//要推送的用户openid
                .templateId("v8mSfHwbzxP-5KnrVvwa6ZTXQWXYtncGzlXpbg5tFY0")//模板id
                .url("http://cljj.mynatapp.cc/#/pay/"+orderId)//点击模板消息要访问的网址
                .build();
